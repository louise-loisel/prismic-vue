...
try {
  console.warn('[prismic-vue] This git version of `prismic-vue/tree/nuxt` is deprecated and will be removed. For more information please check installation warning or https://github.com/prismicio/prismic-vue/tree/nuxt#readme');
} catch (error) {
  // Fail silently
}
